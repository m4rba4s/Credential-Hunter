...
mod tests {
    ...
    fn test_entropy_calculation() {
        ...
        assert!(
            entropy > 4.0,
            "High entropy string should have entropy > 4.0"
        );
        ...
        assert!(
            entropy < 1.0,
            "Low entropy string should have entropy < 1.0"
        );
    }
    ...
    fn test_credential_patterns() {
        ...
        let test_cases = vec![
            ...
            ("Stripe API Key", "sk_test_1234567890abcdefghijklmnopqrstuvwxyzABCD", r"sk_test_[a-zA-Z0-9]{40}"),
    ...
    fn test_false_positive_filtering() {
        ...
        let test_cases = vec![
            ...
            ("real_looking", "sk_live_PLACEHOLDER_MASKED", false),
        ];
        ...
        for (name, credential, should_be_filtered) in test_cases {
            ...
            assert_eq!(
                is_test, should_be_filtered,
                "Test filtering failed for {}",
                name
            );
        }
    }
